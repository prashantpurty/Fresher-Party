  ...
  return (
    <div className="relative h-svh w-full flex bg-black flex-col items-center justify-center overflow-hidden  bg-background md:shadow-xl">
      ...
      <NeonGradientCardCom className="max-w-sm h-fit items-center justify-center text-center">
        <span className="z-10 whitespace-pre-wrap bg-gradient-to-br from-[#ff2975] from-35% to-[#00FFF1] bg-clip-text text-center text-6xl font-bold leading-none tracking-tighter text-transparent dark:drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
